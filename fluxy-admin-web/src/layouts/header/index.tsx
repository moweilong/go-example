    ...
    return (
        ...
        >
            ...
            <div className='flex items-center justify-between flex-1 pr-[24px]'>
                <Input
                    style={{ borderRadius: 8, outline: "none", boxShadow: "none" }}
                    className="w-[400px] h-[50px] focus:(border-[rgb(135,94,196)]) <lg:hidden"
                    size="large"
                    prefix={<IconFangdajing style={{ color: "#697586", paddingRight: 8 }}></IconFangdajing>}
                    placeholder={t("jhqxJPbn" /* 搜索菜单 */)}
                    allowClear
                >
                </Input>
                <div className='pl-[20px] lg:hidden' onClick={() => { setCollapsed(!collapsed) }}>
                    <MenuOutlined />
                </div>
