...
import (
	"github.com/moweilong/go-example/miniblog/cmd/mb-apiserver/app/options"
	"github.com/moweilong/go-example/miniblog/pkg/version"
...
• High-quality code.`,
	...
	// 配置读取优先级：配置文件 命令行 环境变量未生效（没有对应标签）
