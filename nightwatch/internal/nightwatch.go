...
import (
	...
	"github.com/moweilong/go-example/nightwatch/internal/watcher"
	"github.com/moweilong/go-example/nightwatch/pkg/db"
	...
	// 触发 init 函数
	_ "github.com/moweilong/go-example/nightwatch/internal/watcher/all"
)
